...
export const SvgSelector = ({id}: Props) => {
    switch (id) {
        ...
        case 'logout':
            return <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="36px"
        ...
        case 'login':
            return <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 20 20" height="36px"
